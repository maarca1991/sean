			...
			<div class="col-lg-6 get_in_touch_col">
				<div class="shadow p-5">
					<div class="get_in_touch_contents">
						...
						<form name="frm" id="frm" method="post" action="<?php echo SITEURL; ?>process-signin/">
							<div>
								<input id="name" class="form_input input_email input_ph" type="text" name="name" placeholder="Name" required="required">
								...
								<input id="cpassword" class="form_input input_name input_ph" type="password" name="cpassword" placeholder="Confirm Password" required="required" data-error="Confirm password is required.">
							</div>
	...
	$(function(){
		$("#frm").validate({
			...
			messages: {
				...
				cpassword:{required:"Please enter confirm password.",equalTo:"Confirm password is't match with password."}
			},
