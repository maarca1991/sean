...
(function (window, $, undefined) {
    ...
    $.html5imageupload = function html5imageupload(options, element) {
        ...
        this.button.saving = '<div class="btn btn-warning saving">' + (this.options.saveLabel || 'Saving...') + ' <i class="fa fa-times"></i></div>';
        this.button.zoomin = '<div class="btn btn-primary btn-zoom-in"><i class="fa fa-expand"></i></div>';
        this.button.zoomout = '<div class="btn btn-info btn-zoom-out"><i class="fa fa-compress"></i></div>';
        this.button.zoomreset = '<div class="btn btn-warning btn-zoom-reset"><i class="fa fa-arrows-alt"></i></div>';
