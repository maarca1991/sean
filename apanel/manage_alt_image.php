...
<body id="page-top">
	...
	function displayRecords(numRecords) {
		...
		var data_url    = "<?php echo ADMINURL; ?>ajax_get_<?php echo $main_page; ?>.php?show=" + numRecords + "&searchName=" + searchName + "&product_id=<?php echo $product_id; ?>";
		$("#results").html("");
		$(".loading-div").show();
	...
	function del_conf(id){
		...
		if(r){
			window.location.href='<?php echo ADMINURL; ?>add-<?php echo $page; ?>/delete/<?php echo $product_id; ?>/'+id+'/';
		}
	}
