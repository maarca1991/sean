...
(function (window, $, undefined) {
    ...
    $.html5imageupload = function html5imageupload(options, element) {
        ...
        //buttons
        this.button = {}
        this.button.edit = '<div class="btn btn-info btn-edit"><i class="fa fa-edit"></i></div>'
        this.button.saving = '<div class="btn bg-light btn-warning saving">' + (this.options.saveLabel || 'Saving...') + ' <i class="fa fa-clock"></i></div>';
        this.button.zoomin = '<div class="btn bg-light btn-default btn-zoom-in"><i class="fa fa-search-minus"></i></div>';
        this.button.zoomout = '<div class="btn bg-light btn-default btn-zoom-out"><i class="fa fa-search-plus"></i></div>';
        this.button.zoomreset = '<div class="btn bg-light btn-default btn-zoom-reset"><i class="fa fa-compress-arrows-alt"></i></div>';
        this.button.cancel = '<div class="btn btn-danger btn-cancel"><i class="fa fa-trash"></i></div>';
        ...
        //this.button.del			= '<div class="btn btn-warning saving">' + (this.options.saveLabel || 'Saving...') + ' <i class="fa fa-time"></i></div>';
